...
Sprite_Damage.prototype.setup = function (target) {
    ...
    if (target && target.isPlayer()) {
        ...
        if (result.hpAffected) {
            //"PLAYER GET HURTED".LOG();
            if(this._absDigitsSprite) {
                //"SPRITE EXISTS".LOG();
                //this._absDigitsSprite.setColorTone(KDCore.Color.RED.ARR);
            }
        }
    }
};
...
//Plugin Alpha_ABS automatic build by MVPluginBuilder 1.3 03.08.2018
